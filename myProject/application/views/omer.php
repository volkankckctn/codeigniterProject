            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="<?=base_url()?>admin/home/ayarlar"><i class="icon-gear"></i> Ayarlar </a>
                        </li>
                        <li class="divider"></li>
                        <li><a href="<?=base_url()?>admin/login/cikis_yap"><i class="icon-signout"></i>  </a></li>
                    </ul>
                </li>
                    <!--END ADMIN SETTINGS SECTIONS --></ul></nav></div></div>