    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="panel panel-primary">
                ...
                <?php } ?>
                <P></P>
                <form class="form-horizontal" action="<?=base_url()?>admin/urunler/resim_kaydet/<?=$id?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <?php if(!$this->session->flashdata("mesaj")){?>
                            <div class="col-sm-offset-2 col-sm-10">
                                <img src="<?=base_url()?>uploads/<?=$veri[0]->preview_img ?>" height="200" >
                            </div>
                        <?php } ?>
